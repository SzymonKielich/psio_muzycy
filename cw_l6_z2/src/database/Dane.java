...
public class Dane {
	...
	public static void Dane_initializeMuzycy() {
		...
		muzycy[18] = new Pianista("Marzena", "Jankowska", 4, 800, "Podwójny", true, Dane_wylosujRepertuar(baza));
		muzycy[19] = new Pianista("Zuzanna", "Zając", 2, 500, "Stolikowy", true, Dane_wylosujRepertuar(baza));
		...
		muzycy[25] = new Wokalista("Edyta", "Nowicka", 4, 700, "C3", "E6", Dane_wylosujRepertuar(baza));
		muzycy[26] = new Wokalista("Halina", "Sikora", 3, 500, "F3", "C7", Dane_wylosujRepertuar(baza));
		muzycy[27] = new Wokalista("Magdalena", "Witkowski", 2, 300, "C4", "A8", Dane_wylosujRepertuar(baza));
		muzycy[28] = new Wokalista("Jolanta", "Baran", 1, 200, "H3", "C4", Dane_wylosujRepertuar(baza));
		muzycy[29] = new Wokalista("Elżbieta", "Szewczyk", 4, 700, "A3", "F5", Dane_wylosujRepertuar(baza));
		muzycy[30] = new Wokalista("Patrycja", "Szpak", 2, 300, "B4", "C6", Dane_wylosujRepertuar(baza));
		muzycy[31] = new Wokalista("Mateusz", "Rutkowski", 3, 500, "A1", "H4", Dane_wylosujRepertuar(baza));
		muzycy[32] = new Wokalista("Anastazja", "Ostrowska", 3, 600, "H2", "G5", Dane_wylosujRepertuar(baza));
		muzycy[33] = new Wokalista("Patryk", "Pietrzak", 4, 600, "G1", "H3", Dane_wylosujRepertuar(baza));
		muzycy[34] = new Wokalista("Łukasz", "Olszański", 1, 200, "C2", "Gis3", Dane_wylosujRepertuar(baza));
		muzycy[35] = new Wokalista("Sławomir", "Dudek", 5, 1000, "B1", "C5", Dane_wylosujRepertuar(baza));
		muzycy[36] = new Wokalista("Andrzej", "Wróblewski", 2, 300, "B2", "H4", Dane_wylosujRepertuar(baza));
		muzycy[37] = new Wokalista("Rafał", "Masny", 4, 600, "D2", "A4", Dane_wylosujRepertuar(baza));
		muzycy[38] = new Wokalista("Krzysztof", "Ibisz", 3, 500, "G2", "C5", Dane_wylosujRepertuar(baza));
		muzycy[39] = new Wokalista("Cezary", "Wytwer", 1, 100, "A4", "C5", Dane_wylosujRepertuar(baza));

		/// Saksofoniści

		muzycy[40] = new Saksofonista("Maria", "Nowak", 4, 1000, false, Dane_wylosujRepertuar(baza));
		muzycy[41] = new Saksofonista("Marzena", "Dąbrowska", 2, 500, false, Dane_wylosujRepertuar(baza));
		muzycy[42] = new Saksofonista("Jakub", "Zieliński", 3, 800, false, Dane_wylosujRepertuar(baza));
		muzycy[43] = new Saksofonista("Andrzej", "Kozłowski", 1, 400, true, Dane_wylosujRepertuar(baza));
		muzycy[44] = new Saksofonista("Antoni", "Grajek", 2, 400, false, Dane_wylosujRepertuar(baza));
		muzycy[45] = new Saksofonista("Ignacy", "Krawczyk", 4, 900, true, Dane_wylosujRepertuar(baza));
		muzycy[46] = new Saksofonista("Laura", "Jasińska", 1, 300, true, Dane_wylosujRepertuar(baza));
		muzycy[47] = new Saksofonista("Emilia", "Skowrońska", 5, 1200, false, Dane_wylosujRepertuar(baza));
		muzycy[48] = new Saksofonista("Iga", "Kos", 4, 500, false, Dane_wylosujRepertuar(baza));
		...
		muzycy[56] = new Saksofonista("Leon", "Chmielewski", 5, 1000, false, Dane_wylosujRepertuar(baza));
	...
	public static void Dane_initializeMikrofon() {
